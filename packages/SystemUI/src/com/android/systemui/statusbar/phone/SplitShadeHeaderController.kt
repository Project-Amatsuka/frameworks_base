...
class SplitShadeHeaderController @Inject constructor(
    ...
    private fun updateResources() {
        val fillColor = Utils.getColorAttrDefaultColor(context,
            android.R.attr.textColorPrimary)
        iconManager.setTint(fillColor)
        val textColor = Utils.getColorAttrDefaultColor(context,
            android.R.attr.textColorPrimary)
        val colorStateList = Utils.getColorAttr(context,
            android.R.attr.textColorPrimary)
        if (textColor != textColorPrimary) {
            ...
            batteryIcon.updateColors(textColorPrimary, textColorSecondary,
                textColorPrimary)
        }
    }
