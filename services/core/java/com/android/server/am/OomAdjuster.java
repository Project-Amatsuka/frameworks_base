...
public class OomAdjuster {
    ...
    private void updateAppFreezeStateLSP(ProcessRecord app) {
        ...
        if (mForceBackgroundFreezerEnabled && getAppOpsManager().checkOpNoThrow(
            ...
            mCachedAppOptimizer.mMainProcessFilter.reportAdjChange(app);
            int adj = mCachedAppOptimizer.mMainProcessFilter.getMainProcessAdj(app);
            if (adj >= CachedAppOptimizer.FORCE_FREEZER_MIN_ADJ)
